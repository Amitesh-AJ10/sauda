...
export function DialogueBox({ deal }: DialogueBoxProps) {
  ...
  return (
    <div
      ...
      className="flex w-full items-start gap-3 rounded border-4 border-black bg-black/90 p-3 font-retro text-white"
    >
      <div
        aria-hidden="true"
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-white bg-slate-700 text-xl"
      >
        🧑‍⚕️
      </div>
